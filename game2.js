...
const levelThresholds = [0, 50, 150, 400, 1000, 2500, 6000, 15000, 35000, 80000];
...
function create() {
    ...
    moneyText = this.add.text(400, 80, '0 ₽', {
        fontSize: '48px',
        color: '#00ff00'
    }).setOrigin(0.5);
    ...
    // прогресс бар
    progressBarBg = this.add.rectangle(400, 180, 300, 20, 0x333333).setOrigin(0.5);
    progressBarFill = this.add.rectangle(250, 180, 0, 20, 0x2ecc71).setOrigin(0, 0.5);
    ...
    button = this.add.circle(400, 300, 100, levelColors[0]).setInteractive({ useHandCursor: true })
    ...
    levelText = this.add.text(400, 150, `Уровень ${level} ${totalEarned}`,{
        fontSize: '24px',
        color: '#fff'
    }).setOrigin(0.5);
    ...
    // кнопка Купить
    upgradeButton = this.add.rectangle(400, 480, 540, 60, 0x16213e).setInteractive({ useHandCursor: true });


    // текст для описание апгрейда
    upgradeText = this.add.text(400, 480, `Купить улучшение за ${upgradeCost} ₽`, {
        fontSize: '24px',
        color: '#fff'
    } ).setOrigin(0.5);
    ...
    // кнопка Купить
    autoClickUpgradeButton = this.add.rectangle(400, 560, 540, 60, 0x16219e).setInteractive({ useHandCursor: true });


    // текст для автоклика
    autoClickUpgradeText = this.add.text(400, 560, `Купить автоклик за ${autoClickCost}`, {
        fontSize: '24px',
        color: '#fff'
    }).setOrigin( 0.5)
